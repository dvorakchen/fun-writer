...
podman run --pod fun-writer-pod --name postgres -e POSTGRES_USER=postgres -e POSTGRES_PASSWORD=123123 -e POSTGRES_DB=fun-writer -v ~/data:/var/lib/postgresql/data -d hub.aiursoft.cn/postgres:latest   
